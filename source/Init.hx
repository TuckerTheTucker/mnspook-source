...
class Init extends FlxState
{
	...
	public static var gameSettings:Map<String, Dynamic> = [
		...
		'Toggle Shader Filter' => [
			true,
			Checkmark,
			"Toggles wether you want the shader filter during the songs to be displayed.",
			NOT_FORCED
		],
		'Hitsound' => [
			'none',
			Selector,
			'toggle which hitsound you want to play after hitting a note.',
			NOT_FORCED,
			['none', 'basic', 'note tick', 'bubble', 'scroll', 'smw coin', 'smw kick', 'switch snap', 'undertale', 'fart']
		],
	];
