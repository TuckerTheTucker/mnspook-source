...
class Paths
{
	...
	inline static public function voicesDad(song:String):Any {
		var songKey:String = '${CoolUtil.swapSpaceDash(song.toLowerCase())}/VoicesDad';
		var voices = returnSound('songs', songKey);
		return voices;
	}

	inline static public function voicesBF(song:String):Any {
		var songKey:String = '${CoolUtil.swapSpaceDash(song.toLowerCase())}/VoicesBF';
		var voices = returnSound('songs', songKey);
		return voices;
	}
