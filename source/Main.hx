...
class Main extends Sprite
{
	...
	public static var gameVersion:String = '1.0'; //this forever engine version is 0.3, this mod version is 1.0
	...
	**/
	public static var gameWeeks:Array<Dynamic> = [
		[['Spoopy', 'Trick', 'Treat'], ['wicherus'], [0xFFFF7D42], 'Melodies Down Your Spine!']
	];
