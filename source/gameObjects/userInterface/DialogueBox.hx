...
class DialogueBox extends FlxSpriteGroup
{
	...
	public function new(?talkingRight:Bool = false, ?daDialogue:String)
	{
		...
		nameText.font = Paths.font('splatter.otf');
	...
	function changeCharText(char:String)
	{
		...
		{
			case 'wicherus':
				nameText.text = 'Wicherus!';
				nameText.color = 0xFFFF7D42;
				nameText.borderColor = FlxColor.fromRGB(12, 12, 12);
			case 'todd':
				nameText.text = 'Todd';
				nameText.color = FlxColor.fromRGB(35, 14, 0);
				nameText.borderColor = FlxColor.fromRGB(255, 199, 165);
			case 'bf':
