	...
	public static function returnDefaultNote(assetModifier, strumTime, noteData, noteType, noteAlt, ?isSustainNote:Bool = false, ?prevNote:Note = null):Note
	{
		...
		switch (assetModifier)
		{
			...
			default: // base game arrows for no reason whatsoever
				...
				{
					case 1:
						daPath = 'NOTE_assets_trick';
					case 2:
						daPath = 'NOTE_assets_treat';
					default:
						daPath = 'NOTE_assets';
				}
				newNote.frames = Paths.getSparrowAtlas(ForeverTools.returnSkinAsset(daPath, assetModifier, Init.trueSettings.get("Note Skin"),
					'noteskins/notes'));
