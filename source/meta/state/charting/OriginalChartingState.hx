...
class OriginalChartingState extends MusicBeatState
{
	...
	**/
	...
	var typeText:FlxText = new FlxText(10, 10, 0, "Note Type: 0", 24);
	...
	function addSongUI():Void
	{
		...
		var check_voices_dad = new FlxUICheckBox(10, 25, null, null, "Opponent has voice track", 200);
		...
		var check_voices_bf = new FlxUICheckBox(10, 45, null, null, "Player has voice track", 200);
	...
	override function update(elapsed:Float)
	{
		...
		//yoshubs why you made me waste so much time looking up bbpanzu's custom note tutorial and you didnt tell me it was already mostly implemented >:C
