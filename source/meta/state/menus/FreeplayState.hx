...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		**/
		...
		scoreText.setFormat(Paths.font("splatter.otf"), 32, FlxColor.WHITE, RIGHT);
		...
		creativeText = new FlxText(20, 20, 0, 'Creative Mode (Press 7 to Toggle)', 36);
		creativeText.setFormat(scoreText.font, 36, FlxColor.WHITE, RIGHT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		creativeText.visible = FlxG.save.data.weekCompleted;
		add(creativeText);

		creativeText.color = (FlxG.save.data.creativeMode ? FlxColor.LIME : FlxColor.RED);
	...
	override function update(elapsed:Float)
	{
		...
		if(FlxG.keys.justPressed.SEVEN) {
			if (FlxG.save.data.weekCompleted) {
				FlxG.save.data.creativeMode = !FlxG.save.data.creativeMode;
				creativeText.color = (FlxG.save.data.creativeMode ? FlxColor.LIME : FlxColor.RED);
				FlxG.save.flush();
			}
		}
